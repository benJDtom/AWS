...
CloudFront  | Maintain a cache of the website and improve load times         |$2 Monthly
API Gateway | Handle incoming contact forms via restful API, pass to Lambda  |¢15 Monthly
Lambda      | Generate email with contact form information                   |$1 Monthly
